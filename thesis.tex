...
\paragraph{Parallell version of the application}
\input{code/bruteforce.tex}
\paragraph{Non Parallell version of the application}
...
%fixme: can we write that we was lucky in a thesis?
...
for a module that fits in slot A might need to be adjusted to fit in slot B,
...
Gropp et al.\cite{gropp1996high} discusses the design choices made when
...
Miller \cite{miller2002pympi} \cite{millerparallel} gives a hand on approach on
...
understand explanation of the principle behind MPI and how to write a parallel
application with it. 
