...
Scalability is when increasing the resourced the performance is increased
just as much. 
\begin{table}[h!]
\rowcolors{1}{gray!40}{}
\begin{tabular}{c c c}
...
metric is however not perfect %TODO: why is it not perfect?
...
{\small\input{code/common.tex}}
\paragraph{Parallel version of the application}
{\small\input{code/bruteforce.tex}}
\paragraph{Non Parallel version of the application}
{\small\input{code/bruteforce_noparallel.tex}}
